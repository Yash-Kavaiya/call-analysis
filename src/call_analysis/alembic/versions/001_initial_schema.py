...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("pii_findings", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="[]"),
        sa.Column("agents", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="{}"),
        sa.Column("waveform_peaks", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="[]"),
    ...
    op.create_table(
        "system_metrics",
        sa.Column("id", sa.Integer(), nullable=False, server_default=sa.text("nextval('system_metrics_id_seq'::regclass)")),
