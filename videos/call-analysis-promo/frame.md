...
colors:
  ...
  text-muted: "#8B8BA3"
  text-light: "#656565"
  accent-light: "rgba(118, 185, 0, 0.08)"
  accent-medium: "rgba(118, 185, 0, 0.15)"
  border: "rgba(118, 185, 0, 0.2)"
  card-bg: "rgba(118, 185, 0, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  tag:     { fontFamily: "Segoe UI", px: 12, weight: 600, color: "primary" }
  counter: { fontFamily: "Segoe UI", px: 13, weight: 600, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Segoe UI, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Segoe UI", cqw: 1.25, weight: 600, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Segoe UI", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Segoe UI", cqw: 2.4, weight: 600, lineHeight: 1.35, color: "text" }
