...
typography:
  # — reading ramp —
  body:    { fontFamily: "Segoe UI", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "Segoe UI", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  caption: { fontFamily: "Segoe UI", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  ...
  h3:      { fontFamily: "Segoe UI", cqw: 2.8, weight: 600, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "Segoe UI", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "Segoe UI", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "Segoe UI", cqw: 5.5, weight: 900, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Segoe UI", cqw: 7.5, weight: 800, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "Segoe UI", cqw: 7.5, weight: 900, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "Segoe UI", cqw: 10.0, weight: 900, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Segoe UI", cqw: 10.5, weight: 900, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Segoe UI", cqw: 13.0, weight: 900, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **Segoe UI** (display) / **system-ui** (body); ignore any preset font name lingering in prose.
